...
StockResponse _$StockResponseFromJson(Map<String, dynamic> json) =>
    StockResponse(
      ...
      purchaseRetQty: json['PurchaseRetQty'] as int?,
      saleRetQty: json['SaleRetQty'] as int?,
      transferInQty: json['TransferInQty'] as int?,
      transferOutQty: json['TransferOutQty'] as int?,
      ...
      cleanInQty: json['CleanInQty'] as int?,
      stockQty: (json['StockQty'] as num?)?.toDouble(),
      reOrderQty: json['ReOrderQty'] as int?,
    );
